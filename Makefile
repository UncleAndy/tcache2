...
sletat_loader: apps/loaders/sletat_loader.go apps/loaders/sletat/* cache/* db/* apps/workers/worker_base/*
...
data2db_manager: apps/data2db/data2db_manager.go cache/* db/* apps/data2db/*
	go build apps/data2db/data2db_manager.go
data2db_worker: apps/data2db/data2db_worker.go cache/* db/* apps/data2db/*
