...
func init_test_redis_multi() {
	cache.RedisSettings = nil
	cache.ReadSettings("redis_test_main_mode_multi.yaml")
	cache.RedisInit()
}

func TestMultiCacheSetSimple(t *testing.T) {
...
func TestMultiCacheGetSimple(t *testing.T) {
	init_test_redis_multi()
...
func TestMultiRPushSimple(t *testing.T) {
	init_test_redis_multi()
...
func TestMultiLPopSimple(t *testing.T) {
	init_test_redis_multi()
...
func TestMultiLRangeSimple(t *testing.T) {
	init_test_redis_multi()
